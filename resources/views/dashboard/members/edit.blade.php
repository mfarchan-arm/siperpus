    ...
    <div class="col">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <img src="{{ asset('storage/images/' . $member->nama_gambar) }}"
            ...
            <div class="card-body">
                <form method="post" action="/dashboard/members/{{ $member->id }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('nisn') is-invalid @enderror" name="nisn"
                                required autofocus value="{{ old('nisn', $member->nisn) }}" maxlength="10"
                                id="intTextBox2">
                            @error('nisn')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="tgl_lahir" value="{{ $member->tgl_lahir }}">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="intTextBox"
                                name="no_hp" value="{{ old('no_hp', $member->no_hp) }}" maxlength="15" required>
                            @error('no_hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
