    ...
    <div class="row">
        <div class="col-md-4 ">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                    width="150px" src="{{ asset('storage/images/' . $user->nama_gambar) }}"><span
                    class="font-weight-bold">{{ $user->nama }}</span><span class="text-black-50">{{ $user->jabatan
                    }}</span><span>
                </span></div>
        </div>
        <div class="col-md-6 ">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col"><label class="labels">Nama Lengkap</label><input type="text" class="form-control"
                            value="{{ $user->nama }}" readonly></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Jabatan</label><input type="text" class="form-control"
                            value="{{ $user->jabatan }}" readonly></div>
                    ...
                    <a href="/dashboard/profiles/{{ $user->id }}/edit" class="btn btn-warning mt-3">Edit Profil</a>
                </div>
            </div>
        </div>
    </div>
